...
randarray = np.random.permutation([0,1,2])
randarray2 = np.random.permutation([0,1,2])
...
##################
#Left over code that causes issues when deleted
# UR3 home location
...
def main():
   ...
   #Calling to spawn blocks, posititions are changed in the yaml file
    ...
    #First Shape Spawn
    print(randarray[0],'projectindex0')
    lab2_spawn.spawn(randarray[0],1)
    time.sleep(1)
#big green move
    if randarray[0] == 0:
        move_block(pub_command,loop_rate,project_funcs.lab_invk(0.2,0,0.075,-90),project_funcs.lab_invk(-.1,-.3,0.075,-90),project_funcs.lab_invk(-.1,-0.3,0.15,-90))
#yellow prism move
    if randarray[0] == 1:
        move_block(pub_command,loop_rate,project_funcs.lab_invk(0.2,0,0.075,-90),project_funcs.lab_invk(0,0.55,0.075,0),project_funcs.lab_invk(0,0.55,0.2,0))  
#red cylinder move            
    if randarray[0] == 2:
        move_block(pub_command,loop_rate,project_funcs.lab_invk(0.3,0,0.075,-90),project_funcs.lab_invk(0,-.4,0.075,-90),project_funcs.lab_invk(0,-.4,0.15,-90))

    #Second Shape Spawn
    print(randarray[1],'projectindex1')
    lab2_spawn.spawn(randarray[1],1)
    time.sleep(1)
#big green move
    if randarray[1] == 0:
        move_block(pub_command,loop_rate,project_funcs.lab_invk(0.2,0,0.075,-90),project_funcs.lab_invk(-.1,-.3,0.075,-90),project_funcs.lab_invk(-.1,-0.3,0.15,-90))
...
#red cylinder move            
    ...
    #Third Shape Spawn
    print(randarray[2],'projectindex2')
    lab2_spawn.spawn(randarray[2],1)
    time.sleep(1)
#big green move
    if randarray[2] == 0:
        move_block(pub_command,loop_rate,project_funcs.lab_invk(0.2,0,0.075,-90),project_funcs.lab_invk(-.1,-.3,0.075,-90),project_funcs.lab_invk(-.1,-0.3,0.15,-90))
...
#red cylinder move            
    if randarray[2] == 2:
        move_block(pub_command,loop_rate,project_funcs.lab_invk(0.3,0,0.075,-90),project_funcs.lab_invk(0,-.4,0.075,-90),project_funcs.lab_invk(0,-.4,0.15,-90))
################################
#Second Overall Spawning
#################3
    #First Shape Spawn
    print(randarray2[0],'project2index0')
    lab2_spawn.spawn(randarray2[0],2)
    time.sleep(1)
#big green move
    if randarray2[0] == 0:
        move_block(pub_command,loop_rate,project_funcs.lab_invk(0.2,0,0.075,-90),project_funcs.lab_invk(-.2,-.1,0.075,-90),project_funcs.lab_invk(-.2,-0.1,0.15,-90))
#yellow prism move
    if randarray2[0] == 1:
        move_block(pub_command,loop_rate,project_funcs.lab_invk(0.2,0,0.075,-90),project_funcs.lab_invk(0,0.55,0.15,0),project_funcs.lab_invk(0,0.55,0.25,0))  
#red cylinder move            
    if randarray2[0] == 2:
        move_block(pub_command,loop_rate,project_funcs.lab_invk(0.3,0,0.075,-90),project_funcs.lab_invk(.1,-.1,0.075,-90),project_funcs.lab_invk(.1,-.1,0.15,-90))

    #Second Shape Spawn
    print(randarray2[1],'project2index1')
    lab2_spawn.spawn(randarray2[1],2)
    time.sleep(1)
#big green move
    if randarray2[1] == 0:
        move_block(pub_command,loop_rate,project_funcs.lab_invk(0.2,0,0.075,-90),project_funcs.lab_invk(-.2,-.1,0.075,-90),project_funcs.lab_invk(-.2,-0.1,0.15,-90))
...
#red cylinder move            
    ...
    #Third Shape Spawn
    print(randarray2[2],'project2index2')
    lab2_spawn.spawn(randarray2[2],2)
    time.sleep(1)
#big green move
    if randarray2[2] == 0:
        move_block(pub_command,loop_rate,project_funcs.lab_invk(0.2,0,0.075,-90),project_funcs.lab_invk(-.2,-.1,0.075,-90),project_funcs.lab_invk(-.2,-0.1,0.15,-90))
